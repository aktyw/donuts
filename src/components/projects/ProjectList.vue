<template>
  <select
    ...
    class="select select-sm font-normal select-bordered w-[11rem] max-w-[11rem] focus-visible:-outline-offset-2 focus-visible:outline-2 focus-visible:outline-accent hover:bg-base-200 rounded"
